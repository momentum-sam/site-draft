...
export const HeroSection: React.FC<HeroSectionProps> = ({ videoRef }) => {
    ...
    return (
        <section className="h-screen flex flex-col justify-between px-5 pb-12 pt-0 md:pt-32 md:px-10 lg:px-12 md:pb-12 relative">
            <div className="md:hidden flex-1 flex flex-col justify-center pt-20 -mx-5">
                <MobileHeroVideo />
            </div>
